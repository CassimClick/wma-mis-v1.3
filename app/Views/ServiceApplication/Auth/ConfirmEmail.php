                                ...
                                <div class="card text-dark p-4">
                                    <div class="row justify-content-center align-items-center">
                                        <div class="col-md-6 text-center">
                                            ...
                                            <img id="image" src="<?= base_url() ?>/ServiceApplication/assets/img/email.png" alt="wma logo">
                                        </div>
                                    </div>
                                    <h4 class="text-center">Check your email to activate your account</h4>
                                    <p>We have sent message to <b><?=$email ?></b> with link to activate your account</p>
                                    ...
                                    <button type="button" class="btn btn-primary mt-3">Resend Activation Email</button>
                                </div>
                            </div>
                        </div>
