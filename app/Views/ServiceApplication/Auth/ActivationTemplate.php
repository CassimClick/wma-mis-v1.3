                                                    ...
                                                    <tr>
                                                        <td class="v-container-padding-padding" style="overflow-wrap:break-word;word-break:break-word;padding:10px 30px 30px 40px;font-family:arial,helvetica,sans-serif;" align="left">
                                                            ...
                                                            <div class="v-text-align" style="color: #333333; line-height: 140%; text-align: left; word-wrap: break-word;">
                                                                ...
                                                                <p style="font-size: 14px; line-height: 140%;"> </p>
                                                                <p style="font-size: 14px; line-height: 140%;"><span style="font-size: 18px; line-height: 25.2px; font-family: 'Crimson Text', serif;">Your account has been created successfully, click the button bellow to activate your account<br /></span></p>
                                                            </div>
                                                    ...
                                                    <tr>
                                                        <td class="v-container-padding-padding" style="overflow-wrap:break-word;word-break:break-word;padding:10px 40px;font-family:arial,helvetica,sans-serif;" align="left">
                                                            ...
                                                            <div class="v-text-align" align="left">
                                                                ...
                                                                <a href="<?= $link ?>" target="_blank" class="v-size-width" style="box-sizing: border-box;display: inline-block;font-family:arial,helvetica,sans-serif;text-decoration: none;-webkit-text-size-adjust: none;text-align: center;color: #ffffff; background-color: #db611e; border-radius: 3px;-webkit-border-radius: 3px; -moz-border-radius: 3px; width:100%; max-width:100%; overflow-wrap: break-word; word-break: break-word; word-wrap:break-word; mso-border-alt: none;border-top-width: 3px; border-top-style: solid; border-top-color: #dddbd9; border-left-width: 3px; border-left-style: solid; border-left-color: #dddbd9; border-right-width: 3px; border-right-style: solid; border-right-color: #dddbd9; border-bottom-width: 3px; border-bottom-style: solid; border-bottom-color: #dddbd9;">
                                                                    <span class="v-padding" style="display:block;padding:15px 40px;line-height:120%;">
                                                                        <p style="font-size: 14px; line-height: 120%;"> ACTIVATE YOUR ACCOUNT</p>
                                                                    </span>
                                                                </a>
