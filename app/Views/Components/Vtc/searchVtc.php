        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-6">
                        <label for="my-input">Driver's Licence</label>

                        <div class="input-group">
                            <input class="form-control license" id="driverLicenseUpdate" type="text" placeholder="Enter Driver's Licence" value="">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" class="form-control" id="licensePlateUpdate" placeholder="Enter Plate Number">
                ...
                <div class="form-group">
                    <label for="my-input">Sicker Number</label>
                    <input id="stickerNumberUpdate" class="form-control vtcSticker" type="text" name="">
                </div>
...
<script>
                        ...
                        `
                                ...
                                | ${response.data.next_calibration}
                                  ...
                                  <i class="fas fa-pen-square"
                                        ...
                                        <input type='text' value='${response.data.plate_number}'  class="vehicleId" hidden >
                                </li>
    ...
    const updateVehicle = document.querySelector('#update-vtc')
    ...
    updateVehicle.addEventListener('click', () => {
        ...
        if (validateInput(activityUpdate) && validateInput(supervisorUpdate) && validateInput(
                supervisorPhoneUpdate) && validateInput(driverNameUpdate) && validateInput(
                vehicleBrandUpdate) &&
            validateInput(licensePlateUpdate) && validateInput(tankCapacityUpdate) && validateInput(statusUpdate) &&
