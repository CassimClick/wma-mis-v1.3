<div class="modal fade" id="productModal" tabindex="1" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true" style="overflow-y: scroll; ">
    <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form name="productDetailsForm" id="productDetailsForm" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="type" id="type" required onchange="switchType(this.value)">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="categoryAnalysis" id="categoryAnalysis" required onchange="javascript: if(this.value =='Linear 2' || this.value =='Area & Linear' || this.value =='Area_Linear') {$('#otherQuantity').show(); $('#gaugeBlock').show()} else {$('#otherQuantity').hide();$('#gaugeBlock').hide()}">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" name="quantity2" id="quantity2" class="form-control" placeholder="Quantity" min="0" required>
                                                    <!-- <small id="declaredQty" class="text-muted">Gross Quantity = 2000 g</small> -->
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3 local">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="refNumber" id="refNumber" class="form-control" placeholder="Ref Number" required>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="grosValue" id="grosValue" class="form-control" placeholder="Gross Weight" readonly required>
                                ...
                                <div class="col-md-4" id="gaugeBlock" style="display: none;">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="grosValue2" id="grosValue2" class="form-control" placeholder="Gauge/Diameter/Thickness" readonly required>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="sampleSize" id="sampleSize" class="form-control" placeholder="Sample Size" required readonly>
                                    </div>
                                </div>
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="number" name="pycnometerMass" id="pycnometerMass" class="form-control" placeholder="Mass Of Pycnometer" required>

                                                    </div>
                                                    <div class="form-group">
                                                        <label for="">Mass Of Pycnometer + Product</label>
                                                        <input type="number" name="pycnometerProduct" id="pycnometerProduct" class="form-control" placeholder="Mass Of Pycnometer + Product" required>
