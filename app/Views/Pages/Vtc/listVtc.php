                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h5 class="card-title"><?= $page['heading'] ?><b>(<?= count($vtcResults) ?>)</b> &nbsp; &nbsp; &nbsp; Total Amount: <b class="">Tsh <?= totalAmount($vtcResults) ?></b></h5>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">

                            <!-- <h5>Total Amount: <span class="">Tsh <?= totalAmount($vtcResults) ?></span></h5> -->
                                    ...
                                    <tbody>
                                        ...
                                        <?php foreach ($vtcResults as $vtc) : ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="<?=base_url('downloadCalibrationChart/'. substr($vtc->trailer_id,0,5))?>" class="btn btn-primary btn-sm" target="_blank"> <i class="fas fa-download"></i> Download Chart</a>
                                                </td>
