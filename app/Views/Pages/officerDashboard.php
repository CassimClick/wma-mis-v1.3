...
<section class="content body">
    <div class="container-fluid">
        <div class="row">
            ...
            <!-- ./col -->
            <?php $prepackage = []; ?>
            <?php foreach ($prePackageData as $value) : ?>
                <?php array_push($prepackage, $value['customer']) ?>
            <?php endforeach; ?>
            <div class="col-lg-3 col-12">
                <div class="small-box bg-primary">
                    <div class="inner">
                        <h3><?= count($prepackage) ?></h3>
                    ...
                    <a href="<?= base_url() ?>/viewPrepackage" class="small-box-footer">
                        More info <i class="far fa-arrow-circle-right"></i>
                    </a>
                </div>
            </div>
            ...
            <div class="col-lg-3 col-12">
                <div class="small-box bg-primary">
                    <div class="inner">
                        <h3><?= meterQuantityAll($totalWaterMeter) ?></h3>
