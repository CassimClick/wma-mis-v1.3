...
<?php if ($role == 1) : ?>
                        ...
                        <div class="modal-body">
                            <div class="row">
                                <div class="form-group col-md-12">
                                    ...
                                    <select class="form-control" name="" id="measurementOptions" onchange="javascript: $('#currentQuantity').val(this.value.replace(/[^\d.-]/g, '')); $('#productQuantity').val(this.value.replace( /(<([^>]+)>)/ig, ''));$('#dataSheetForm')[0].reset();checkQuantityId(this.value)">
                            ...
                            <div class="form-group col-md-12">
                                <input type="text" class="form-control" id="currentQuantity">
    ...
    <!-- Button trigger modal -->
    <button type="button" class="btn btn-primary btn-lg" data-toggle="modal" data-target="#modelPrint">
        Launch
    </button>
    ...
    <section style="margin:0; padding:0;">
        <div class="content" style="margin:0; padding:0;">
            <div>
                <div class="modal fade" id="modelPrint" tabindex="-1" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true" style="padding: 0;margin:0;">
                    <div class="modal-dialog modal-xl" role="document">
                        <div class="modal-content">
                ...
                success: function(response) {
                    ...
                    if (response.products != '') {
                        ...
                        theProducts.forEach(product => {
                            ...
                            //FIXME // check overall status if there are two sets of measurements 
                            productsTable += /*html*/ `
 ...
 <input   type="text" name="customerHash[]" id="prodId[]" value="${product.hash}" class="form-control mb-1">
        ...
        function getCustomerInfo(hash) {
            ...
            // let lotSizes = []
            <?php if (url_is('prePackage')) : ?>
                let url = 'editPrePackageCustomer'
            <?php else : ?>
                let url = 'getPrePackageCustomer'
            <?php endif; ?>
        ...
        function renderMeasurementData(sampleSize) {
            ...
            `
                    for (let index = 0; index <= (sampleSize * 2) - 1; index++) {
                       ...
                       <td>
                        <input tabindex="${index+1}" id="height" min="0" max="100000000" step="any" name="height[]" oninput="checkForAreaError(this)"  data-weight='net'   class="form-control netQuantity" type="number" required>
                        </td>
            ...
            fetch('checkQuantityId', {
                ...
                .then(data => {
                    ...
                    if (data.status == 1) {
                        ...
                        swal({
                            title: `Measurement For ${id} Already Exist`,
                            icon: "warning",
                            timer: 4500
                        });
        ...
        function selectProduct(id) {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    let grossOptions = []
                    grossOptions.push(response.data.gross_quantity + '' + response.data.unit, response.data.quantity_2 + '' + response.data.unit_2)
                    ...
                    $('#currentQuantity').val(grossOptions[0].replace(/[^\d.-]/g, ''))
