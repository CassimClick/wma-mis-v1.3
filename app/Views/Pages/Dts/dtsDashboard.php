...
<section class="content body">
    <div class="container-fluid">
        ...
        <div class="row">
            <!-- <div class="col-12 col-sm-6 col-md-4">
                <div class="info-box mb-3">
                    ...
                    <div class="info-box-content">
                        ...
                        <span class="">Paid: Tsh</span><br>
                        <span class="">Pending: Tsh</span>
                        <span class="info-box-number">Total: Tsh </span>
                    </div>
            ...
            <div class="col-12 col-sm-6 col-md-4">
                <div class="info-box mb-3">
                    ...
                    <div class="info-box-content">
                        <span class="info-box-number">VTC(<?= instrumentQuantity($vtcDetails) ?>)</span>
            ...
            <div class="col-12 col-sm-6 col-md-4">
                <div class="info-box mb-3">
                    ...
                    <div class="info-box-content">
                        <span class="info-box-number">SBL(<?= instrumentQuantity($sblDetails) ?>)</span>
            ...
            <div class="col-12 col-sm-6 col-md-4">
                <div class="info-box mb-3">
                    ...
                    <div class="info-box-content">
                        <span class="info-box-number">Water Meters(<?= meterQuantityAll($waterMeterDetails) ?>)</span>
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div id="directorChart" class="mt-5"></div>
            </div>
