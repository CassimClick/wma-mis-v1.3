...
<section class="content body">
    <div class="container-fluid">
        ...
        <?= view('widgets/customerOptions.php') ?>
        <?= view('components/Customers') ?>
            ...
            <div class="col-md-6">
                <div class="card card-primary">
                    <div class="card-header">
                        <h3 class="card-title"><i class="fal fa-cogs icon"></i>Sbl Technical Details</h3>
                    ...
                    <!-- /.card-header -->
                    <div class="card-body">
                        <?= $this->include('Components/Lorries/lorryTechnicalDetails'); ?>
                    </div>
                    <!-- /.card-body -->
                    <div class="card-footer">
                        <div class="form-group">
                            ...
                            <button type="button" onclick="publishSblData()" class="btn btn-primary btn-sm">
                                Save</button>
                        </div>
                    </div>
                    <!-- /.card-footer -->
