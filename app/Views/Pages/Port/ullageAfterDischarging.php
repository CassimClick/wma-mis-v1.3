...
const fetchTheShipId = (id) => {
    ...
    logDownload.setAttribute('href', '<?=base_url()?>/downloadUllageAfterDischarging/' + id)
}
</script>
...
<section class="content">
        ...
        <div class="card">
            <div class="card-header">
                <button type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#timeLog-modal"
                    ...
                    Tank </button>
                <button type="button" onclick="fetchAllShipUllageAfterDischarge()" class="btn btn-success btn-sm"
            ...
            <div class="card-body">
                ...
                <table class="table">
                    ...
                    <tbody id="currentUllageAfterDischarging">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            <input id="shipId" class="form-control" type="text" name="" hidden>
                        </div>
                        <div class="row">
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if (response == 'Added') {
                        // grabLastLog()
                        clearInputs()
                        fetchAllShipUllageAfterDischarge(shipId.value)
    ...
    function computeColumn(obsvdTemp, obsvdVol, freeWtr, freeWtrVol, grossObsvdVol, VCF54B, GSV15C, VCF60B, GSV20C) {
        ...
        $('#currentUllageAfterDischarging').append(
            `
            <td></td>
    ...
    function fetchAllShipUllageAfterDischarge() {
        ...
        if (shipId.value != '') {
            ...
            let ullageB4Tons_15 = 0
            let ullageB4Tons_20 = 0
            $('#currentUllageAfterDischarging').html('')
            // const shipId = document.querySelector('#shipId')
            $.ajax({
                type: "POST",
                url: "getAvailableShipUllageAfterDischarge",
                data: {
                    shipId: shipId.value
                },
                dataType: "json",
                success: function(response) {
                    ...
                    if (response != '') {
                        ...
                        response.forEach((res) => {
                            if (res.ullageB4Tons_15) {
                                // console.log(res.ullageB4Tons_15)
                            }
                        ...
                        for (let tank of response) {
                            if (tank.ullageB4Tons_15 && tank.ullageB4Tons_20) {
                                ullageB4Tons_15 += tank.ullageB4Tons_15
                                ullageB4Tons_20 += tank.ullageB4Tons_20
                            }


                            if (tank.observedTemperature != undefined && tank.totalObservedVolume !=
                                undefined && tank.freeWater != undefined && tank.grossObservedVolume !=
                                undefined && tank.freeWaterVolume != undefined && tank
                                .grossObservedVolume != undefined && tank.VCF54B15Centigrade != undefined &&
                                tank.GSV15Centigrade != undefined && VCF60B20Centigrade != undefined && tank
                                .GSV20Centigrade != undefined) {
                        ...
                        computeColumn(obsvdTemp, obsvdVol, freeWtr, freeWtrVol, grossObsvdVol, VCF54B,
                            GSV15C, VCF60B, GSV20C)
                    } else {
                        //$('#currentUllageAfterDischarging').html('<h4>Nothing Found</h4>')
                        //$('.ullageTable').html('')
                        // $('#currentUllageAfterDischarging').html('<h4>Nothing Found</h4>')
                    }
                    ...
                    const totalQuantityBeforeDischarging_15 = ullageB4Tons_15
                    const totalQuantityBeforeDischarging_20 = ullageB4Tons_20

                    const totalQuantityAfterDischarging_15 = (GSV15C * WCFT_15).toFixed(3)
                    const totalQuantityAfterDischarging_20 = (GSV20C * WCFT_20).toFixed(3)

                    const totalDischarged_15 = totalQuantityBeforeDischarging_15 -
                        totalQuantityAfterDischarging_15
                    const totalDischarged_20 = totalQuantityBeforeDischarging_20 -
                        totalQuantityAfterDischarging_20

                    const volume_15 = (totalDischarged_15 / WCFT_15).toFixed(3)
                    const volume_20 = (totalDischarged_20 / WCFT_20).toFixed(3)
                    ...
                    <tr>
                        ...
                        <td>${ullageB4Tons_15}</td>
                        <td>${ullageB4Tons_20}</td>

                    </tr>
                    <tr>

                        <td colspan="2"><b>TOTAL QTY AFTER DISCHARGING (MT) </b></td>
                        <td>${totalQuantityAfterDischarging_15}</td>
                        <td>${totalQuantityAfterDischarging_20}</td>

                    </tr>
                    <tr>

                        <td colspan="2"><b>TOTAL QTY DISCHARGED (MT)</b></td>
                        <td>${(ullageB4Tons_15 - (GSV15C * WCFT_15)).toFixed(3) }</td>
                        <td>${(ullageB4Tons_20 - (GSV20C * WCFT_20)).toFixed(3) }</td>

                    </tr>
                    <tr>

                        <td colspan="2"><b>VOLUME (L)</b></td>
                        <td id="GSV15C">${volume_15}</td>
                        <td id="GSV20C">${volume_20}</td>
    ...
    //=================select all ullage After discharge====================
    </script>
</section>
<?=$this->endSection();?>