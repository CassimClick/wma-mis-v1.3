...
<head>
    ...
    <link rel="stylesheet" href="<?= base_url() ?>/dist/css/form-wizard.css">
...
<body>
                        ...
                        <div class="wizard-inner">
                            ...
                            <ul class="nav nav-tabs" role="tablist">
                                ...
                                <li role="presentation" class="disabled">
                                    <a href="#step2" data-toggle="tab" aria-controls="step2" role="tab" aria-expanded="false"><span class="round-tab">2</span> <i>Technical Details</i></a>
                                </li>
                                <li role="presentation" class="disabled">
                                    <a href="#step3" data-toggle="tab" aria-controls="step3" role="tab"><span class="round-tab">3</span> <i>Pass</i></a>
                                </li>
                                <li role="presentation" class="disabled">
                                    <a href="#step4" data-toggle="tab" aria-controls="step4" role="tab"><span class="round-tab">4</span> <i>Fail</i></a>
                                </li>
                            </ul>
                        </div>
                        ...
                        <form role="form" action="index.html" class="login-box">
                            <div class="tab-content" id="main_form">
                                ...
                                <div class="tab-pane" role="tabpanel" id="step2">
                                    <h4 class="text-center">Scale Technical Details</h4>
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                ...
                                <div class="tab-pane" role="tabpanel" id="step3">
                                    <h4 class="text-center">If A Scale Passed</h4>
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                ...
                                <div class="tab-pane" role="tabpanel" id="step4">
                                    <h4 class="text-center">If A Scale Failed</h4>
    ...
    <script src="<?= base_url() ?>/dist/js/form-wizard.js"></script>
</body>
